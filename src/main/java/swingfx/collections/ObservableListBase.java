...
/**
 * Abstract class that serves as a base class for {@link swingfx.collections.ObservableList} implementations.
 ...
 *      {@link #fireChange(swingfx.collections.ListChangeListener.Change)  } method is provided
 *      for notifying the listeners with a {@code Change} object.
 * <li> Methods for building up a {@link swingfx.collections.ListChangeListener.Change} object. There are various methods called
 ...
 *
 * <p>
 * Note: If you want to create modifiable {@link swingfx.collections.ObservableList} implementation, consider
 * using {@link swingfx.collections.ModifiableObservableListBase} as a superclass.
 * <p>
 ...
 * @see swingfx.collections.ObservableList
 * @see swingfx.collections.ListChangeListener.Change
...
public abstract class ObservableListBase<E> extends AbstractList<E>  implements ObservableList<E> {
    ...
    private final swingfx.collections.ListChangeBuilder<E> changeBuilder = new swingfx.collections.ListChangeBuilder<E>(this);
    ...
    @Override
    public final void addListener(swingfx.collections.ListChangeListener<? super E> listener) {
        listenerHelper = ListListenerHelper.addListener(listenerHelper, listener);
    }

    @Override
    public final void removeListener(swingfx.collections.ListChangeListener<? super E> listener) {
        listenerHelper = ListListenerHelper.removeListener(listenerHelper, listener);
    }
