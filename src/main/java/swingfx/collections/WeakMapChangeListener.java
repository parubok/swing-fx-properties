...
/**
 * A {@code WeakMapChangeListener} can be used, if an {@link swingfx.collections.ObservableMap}
 ...
 * {@link swingfx.collections.MapChangeListener}. The {@code WeakMapChangeListener} should then be
 ...
 * @since JavaFX 2.1
 */
public final class WeakMapChangeListener<K, V> implements swingfx.collections.MapChangeListener<K, V>, WeakListener {

    private final WeakReference<swingfx.collections.MapChangeListener<K, V>> ref;
     ...
     */
    public WeakMapChangeListener(@NamedArg("listener") swingfx.collections.MapChangeListener<K, V> listener) {
        if (listener == null) {
            throw new NullPointerException("Listener must be specified.");
        }
        this.ref = new WeakReference<swingfx.collections.MapChangeListener<K, V>>(listener);
    }
