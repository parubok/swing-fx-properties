...
public class FXCollections {
     ...
     * @since JavaFX 2.1
     */
    public static <E> swingfx.collections.ObservableSet<E> observableSet(Set<E> set) {
        if (set == null) {
            throw new NullPointerException();
        }
     ...
     * @since JavaFX 2.1
     */
    public static <E> swingfx.collections.ObservableSet<E> observableSet(E... elements) {
        if (elements == null) {
            throw new NullPointerException();
        }
    ...
    public static <K, V> swingfx.collections.ObservableMap<K, V> unmodifiableObservableMap(swingfx.collections.ObservableMap<K, V> map) {
        if (map == null) {
            throw new NullPointerException();
        }
     ...
     * @since JavaFX 8.0
     */
    public static <K, V> swingfx.collections.ObservableMap<K, V> checkedObservableMap(swingfx.collections.ObservableMap<K, V> map, Class<K> keyType, Class<V> valueType) {
     ...
     * @since JavaFX 8.0
     */
    public static <K, V> swingfx.collections.ObservableMap<K, V> synchronizedObservableMap(swingfx.collections.ObservableMap<K, V> map) {
        if (map == null) {
            throw new NullPointerException();
        }
    ...
    @ReturnsUnmodifiableCollection
    public static <K, V> swingfx.collections.ObservableMap<K, V> emptyObservableMap() {
     ...
     * @since JavaFX 8.0
     */
    public static swingfx.collections.ObservableIntegerArray observableIntegerArray() {
     ...
     * @since JavaFX 8.0
     */
    public static swingfx.collections.ObservableIntegerArray observableIntegerArray(int... values) {
     ...
     * @since JavaFX 8.0
     */
    public static swingfx.collections.ObservableIntegerArray observableIntegerArray(ObservableIntegerArray array) {
     ...
     * @since JavaFX 8.0
     */
    public static swingfx.collections.ObservableFloatArray observableFloatArray() {
     ...
     * @since JavaFX 8.0
     */
    public static swingfx.collections.ObservableFloatArray observableFloatArray(float... values) {
     ...
     * @since JavaFX 8.0
     */
    public static swingfx.collections.ObservableFloatArray observableFloatArray(ObservableFloatArray array) {
     ...
     * @see #observableList(java.util.List, Callback)
     * @since JavaFX 2.1
     * @return a newly created ObservableList
     */
    public static <E> swingfx.collections.ObservableList<E> observableArrayList(Callback<E, Observable[]> extractor) {
     ...
     */
    public static <K,V> swingfx.collections.ObservableMap<K,V> observableHashMap() {
     ...
     */
    public static <E> swingfx.collections.ObservableList<E> concat(swingfx.collections.ObservableList<E>... lists) {
        if (lists.length == 0 ) {
        ...
        for (swingfx.collections.ObservableList<E> s : lists) {
     ...
     */
    public static<E> swingfx.collections.ObservableList<E> checkedObservableList(swingfx.collections.ObservableList<E> list, Class<E> type) {
        if (list == null) {
            throw new NullPointerException();
        }
     ...
     */
    public static<E> swingfx.collections.ObservableList<E> synchronizedObservableList(swingfx.collections.ObservableList<E> list) {
        if (list == null) {
            throw new NullPointerException();
        }
     ...
     */
    @ReturnsUnmodifiableCollection
    public static<E> swingfx.collections.ObservableSet<E> unmodifiableObservableSet(swingfx.collections.ObservableSet<E> set) {
        if (set == null) {
            throw new NullPointerException();
        }
     ...
     * @since JavaFX 8.0
     */
    public static<E> swingfx.collections.ObservableSet<E> checkedObservableSet(swingfx.collections.ObservableSet<E> set, Class<E> type) {
        if (set == null) {
            throw new NullPointerException();
        }
     ...
     * @since JavaFX 8.0
     */
    public static<E> swingfx.collections.ObservableSet<E> synchronizedObservableSet(swingfx.collections.ObservableSet<E> set) {
        if (set == null) {
            throw new NullPointerException();
        }
     ...
     */
    @SuppressWarnings("unchecked")
    public static <T> void copy(swingfx.collections.ObservableList<? super T> dest, List<? extends T> src) {
     ...
     */
    @SuppressWarnings("unchecked")
    public static <T> void fill(swingfx.collections.ObservableList<? super T> list, T obj) {
     ...
     */
    @SuppressWarnings("unchecked")
    public static <T> boolean replaceAll(swingfx.collections.ObservableList<T> list, T oldVal, T newVal) {
     ...
     */
    @SuppressWarnings("unchecked")
    public static void reverse(swingfx.collections.ObservableList list) {
     ...
     */
    @SuppressWarnings("unchecked")
    public static void rotate(swingfx.collections.ObservableList list, int distance) {
        Object[] newContent = list.toArray();
     ...
     */
    public static void shuffle(swingfx.collections.ObservableList<?> list) {
        if (r == null) {
            r = new Random();
        }
        shuffle(list, r);
     ...
     */
    @SuppressWarnings("unchecked")
    public static void shuffle(swingfx.collections.ObservableList list, Random rnd) {
        Object newContent[] = list.toArray();
     ...
     */
    @SuppressWarnings("unchecked")
    public static <T extends Comparable<? super T>> void sort(swingfx.collections.ObservableList<T> list) {
     ...
     */
    @SuppressWarnings("unchecked")
    public static <T> void sort(swingfx.collections.ObservableList<T> list, Comparator<? super T> c) {
        if (list instanceof SortableList) {
    ...
    private static class SynchronizedObservableList<T> extends SynchronizedList<T> implements swingfx.collections.ObservableList<T> {
        ...
        SynchronizedObservableList(swingfx.collections.ObservableList<T> seq, Object mutex) {
            super(seq, mutex);
            ...
            backingList.addListener(new swingfx.collections.WeakListChangeListener<T>(listener));
        }

        SynchronizedObservableList(swingfx.collections.ObservableList<T> seq) {
            this(seq, new Object());
        }
        ...
        @Override
        public void addListener(swingfx.collections.ListChangeListener<? super T> listener) {
            synchronized (mutex) {
                helper = ListListenerHelper.addListener(helper, listener);
            }
        }
        ...
        @Override
        public void removeListener(swingfx.collections.ListChangeListener<? super T> listener) {
            synchronized (mutex) {
                helper = ListListenerHelper.removeListener(helper, listener);
            }
        }
    ...
    private static class CheckedObservableList<T> extends ObservableListBase<T> implements swingfx.collections.ObservableList<T> {

        private final swingfx.collections.ObservableList<T> list;
    ...
    private static class UnmodifiableObservableSet<E> extends AbstractSet<E> implements swingfx.collections.ObservableSet<E> {

        private final swingfx.collections.ObservableSet<E> backingSet;
        private SetListenerHelper<E> listenerHelper;
        private swingfx.collections.SetChangeListener<E> listener;

        public UnmodifiableObservableSet(swingfx.collections.ObservableSet<E> backingSet) {
        ...
        private void initListener() {
            if (listener == null) {
                ...
                this.backingSet.addListener(new swingfx.collections.WeakSetChangeListener<E>(listener));
            }
        }

        private void callObservers(swingfx.collections.SetChangeListener.Change<? extends E> change) {
    ...
    private static class SynchronizedObservableSet<E> extends SynchronizedSet<E> implements swingfx.collections.ObservableSet<E> {

        private final swingfx.collections.ObservableSet<E> backingSet;
        private SetListenerHelper listenerHelper;
        private final swingfx.collections.SetChangeListener<E> listener;

        SynchronizedObservableSet(swingfx.collections.ObservableSet<E> set, Object mutex) {
            super(set, mutex);
            backingSet = set;
            listener = c -> {
                SetListenerHelper.fireValueChangedEvent(listenerHelper, new SetAdapterChange<E>(SynchronizedObservableSet.this, c));
            };
            backingSet.addListener(new swingfx.collections.WeakSetChangeListener<E>(listener));
        }

        SynchronizedObservableSet(swingfx.collections.ObservableSet<E> set) {
            this(set, new Object());
        }
    ...
    private static class CheckedObservableSet<E> extends AbstractSet<E> implements swingfx.collections.ObservableSet<E> {
        ...
        private void callObservers(swingfx.collections.SetChangeListener.Change<? extends E> c) {
    ...
    private static class CheckedObservableMap<K, V> extends AbstractMap<K, V> implements swingfx.collections.ObservableMap<K, V> {

        private final swingfx.collections.ObservableMap<K, V> backingMap;
        private final Class<K> keyType;
        private final Class<V> valueType;
        private MapListenerHelper listenerHelper;
        private final swingfx.collections.MapChangeListener<K, V> listener;

        CheckedObservableMap(swingfx.collections.ObservableMap<K, V> map, Class<K> keyType, Class<V> valueType) {
            backingMap = map;
            ...
            backingMap.addListener(new swingfx.collections.WeakMapChangeListener<K, V>(listener));
        }

        private void callObservers(swingfx.collections.MapChangeListener.Change<? extends K, ? extends V> c) {
    ...
    private static class SynchronizedObservableMap<K, V> extends SynchronizedMap<K, V> implements swingfx.collections.ObservableMap<K, V> {

        private final swingfx.collections.ObservableMap<K, V> backingMap;
        private MapListenerHelper listenerHelper;
        private final swingfx.collections.MapChangeListener<K, V> listener;

        SynchronizedObservableMap(swingfx.collections.ObservableMap<K, V> map, Object mutex) {
            super(map, mutex);
            backingMap = map;
            listener = c -> {
