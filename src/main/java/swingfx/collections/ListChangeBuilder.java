...
import com.sun.swingfx.collections.ChangeHelper;
...
final class ListChangeBuilder<E> {
    ...
    private final swingfx.collections.ObservableListBase<E> list;
    ...
    ListChangeBuilder(swingfx.collections.ObservableListBase<E> list) {
        this.list = list;
    }
