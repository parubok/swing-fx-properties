        ...
        @Override public String toString(T value) {
            ...
            if (value instanceof LocalDate) {
                ...
                try {
                    ...
                    Logging.getLogger().warning("Converting LocalDate " + value + " to " + chronology + " failed, falling back to IsoChronology.");
                ...
                try {
                    ...
                    Logging.getLogger().warning("Converting LocalDateTime " + value + " to " + chronology + " failed, falling back to IsoChronology.");
                    chronology = IsoChronology.INSTANCE;
