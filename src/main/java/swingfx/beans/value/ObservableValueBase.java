...
/**
 * A convenience class for creating implementations of {@link swingfx.beans.value.ObservableValue}.
...
public abstract class ObservableValueBase<T> implements ObservableValue<T> {
     ...
     */
    @Override
    public void addListener(swingfx.beans.value.ChangeListener<? super T> listener) {
        helper = ExpressionHelper.addListener(helper, this, listener);
    }
