 ...
 * {@link swingfx.beans.property.adapter.JavaBeanIntegerProperty JavaBeanIntegerProperties}. To create
 ...
 * calling {@link #build()}.
 *
 * @see swingfx.beans.property.adapter.JavaBeanIntegerProperty
 * @since JavaFX 2.1
 */
public final class JavaBeanIntegerPropertyBuilder {
    ...
    /**
     * Generate a new {@link swingfx.beans.property.adapter.JavaBeanIntegerProperty} with the current settings.
     *
     ...
     */
    public swingfx.beans.property.adapter.JavaBeanIntegerProperty build() throws NoSuchMethodException {
