 ...
 * {@link swingfx.beans.property.adapter.JavaBeanFloatProperty JavaBeanFloatProperties}. To create
 ...
 * calling {@link #build()}.
 *
 * @see swingfx.beans.property.adapter.JavaBeanFloatProperty
 * @since JavaFX 2.1
 */
public final class JavaBeanFloatPropertyBuilder {
    ...
    /**
     * Generate a new {@link swingfx.beans.property.adapter.JavaBeanFloatProperty} with the current settings.
     *
     ...
     */
    public swingfx.beans.property.adapter.JavaBeanFloatProperty build() throws NoSuchMethodException {
