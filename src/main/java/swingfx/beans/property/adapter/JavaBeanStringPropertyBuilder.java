 ...
 * {@link swingfx.beans.property.adapter.JavaBeanStringProperty JavaBeanStringProperties}. To create
 ...
 * calling {@link #build()}.
 *
 * @see swingfx.beans.property.adapter.JavaBeanStringProperty
 * @since JavaFX 2.1
 */
public final class JavaBeanStringPropertyBuilder {
    ...
    /**
     * Generate a new {@link swingfx.beans.property.adapter.JavaBeanStringProperty} with the current settings.
     *
     ...
     * {@code String}
     */
    public swingfx.beans.property.adapter.JavaBeanStringProperty build() throws NoSuchMethodException {
