 ...
 * {@link swingfx.beans.property.adapter.ReadOnlyJavaBeanStringProperty ReadOnlyJavaBeanStringProperties}. To create
 ...
 * calling {@link #build()}.
 *
 * @see swingfx.beans.property.adapter.ReadOnlyJavaBeanStringProperty
 * @since JavaFX 2.1
 */
public final class ReadOnlyJavaBeanStringPropertyBuilder {
    ...
    /**
     * Generate a new {@link swingfx.beans.property.adapter.ReadOnlyJavaBeanStringProperty} with the current settings.
     *
     ...
     * {@code String}
     */
    public swingfx.beans.property.adapter.ReadOnlyJavaBeanStringProperty build() throws NoSuchMethodException {
