 ...
 * {@link swingfx.beans.property.adapter.ReadOnlyJavaBeanDoubleProperty ReadOnlyJavaBeanDoubleProperties}. To create
 ...
 * calling {@link #build()}.
 *
 * @see swingfx.beans.property.adapter.ReadOnlyJavaBeanDoubleProperty
 * @since JavaFX 2.1
 */
public final class ReadOnlyJavaBeanDoublePropertyBuilder {
    ...
    /**
     * Generate a new {@link swingfx.beans.property.adapter.ReadOnlyJavaBeanDoubleProperty} with the current settings.
     *
     ...
     */
    public swingfx.beans.property.adapter.ReadOnlyJavaBeanDoubleProperty build() throws NoSuchMethodException {
