 ...
 * {@link swingfx.beans.property.adapter.ReadOnlyJavaBeanIntegerProperty ReadOnlyJavaBeanIntegerProperties}. To create
 ...
 * calling {@link #build()}.
 *
 * @see swingfx.beans.property.adapter.ReadOnlyJavaBeanIntegerProperty
 * @since JavaFX 2.1
 */
public final class ReadOnlyJavaBeanIntegerPropertyBuilder {
    ...
    /**
     * Generate a new {@link swingfx.beans.property.adapter.ReadOnlyJavaBeanIntegerProperty} with the current settings.
     *
     ...
     */
    public swingfx.beans.property.adapter.ReadOnlyJavaBeanIntegerProperty build() throws NoSuchMethodException {
