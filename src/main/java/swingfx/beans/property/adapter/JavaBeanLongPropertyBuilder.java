 ...
 * {@link swingfx.beans.property.adapter.JavaBeanLongProperty JavaBeanLongProperties}. To create
 ...
 * calling {@link #build()}.
 *
 * @see swingfx.beans.property.adapter.JavaBeanLongProperty
 * @since JavaFX 2.1
 */
public final class JavaBeanLongPropertyBuilder {
    ...
    /**
     * Generate a new {@link swingfx.beans.property.adapter.JavaBeanLongProperty} with the current settings.
     *
     ...
     */
    public swingfx.beans.property.adapter.JavaBeanLongProperty build() throws NoSuchMethodException {
