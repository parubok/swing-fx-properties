 ...
 * {@link swingfx.beans.property.adapter.ReadOnlyJavaBeanObjectProperty ReadOnlyJavaBeanObjectProperties}. To create
 ...
 * calling {@link #build()}.
 *
 * @see swingfx.beans.property.adapter.ReadOnlyJavaBeanObjectProperty
 *
...
public final class ReadOnlyJavaBeanObjectPropertyBuilder<T> {
    ...
    /**
     * Generate a new {@link swingfx.beans.property.adapter.ReadOnlyJavaBeanObjectProperty} with the current settings.
     *
     ...
     */
    public swingfx.beans.property.adapter.ReadOnlyJavaBeanObjectProperty<T> build() throws NoSuchMethodException {
