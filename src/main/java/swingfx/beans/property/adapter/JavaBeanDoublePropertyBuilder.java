 ...
 * {@link swingfx.beans.property.adapter.JavaBeanDoubleProperty JavaBeanDoubleProperties}. To create
 ...
 * calling {@link #build()}.
 *
 * @see swingfx.beans.property.adapter.JavaBeanDoubleProperty
 * @since JavaFX 2.1
 */
public final class JavaBeanDoublePropertyBuilder {
    ...
    /**
     * Generate a new {@link swingfx.beans.property.adapter.JavaBeanDoubleProperty} with the current settings.
     *
     ...
     */
    public swingfx.beans.property.adapter.JavaBeanDoubleProperty build() throws NoSuchMethodException {
