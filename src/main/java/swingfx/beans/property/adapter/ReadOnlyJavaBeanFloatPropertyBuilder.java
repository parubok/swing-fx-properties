 ...
 * {@link swingfx.beans.property.adapter.ReadOnlyJavaBeanFloatProperty ReadOnlyJavaBeanFloatProperties}. To create
 ...
 * calling {@link #build()}.
 *
 * @see swingfx.beans.property.adapter.ReadOnlyJavaBeanFloatProperty
 * @since JavaFX 2.1
 */
public final class ReadOnlyJavaBeanFloatPropertyBuilder {
    ...
    /**
     * Generate a new {@link swingfx.beans.property.adapter.ReadOnlyJavaBeanFloatProperty} with the current settings.
     *
     ...
     */
    public swingfx.beans.property.adapter.ReadOnlyJavaBeanFloatProperty build() throws NoSuchMethodException {
