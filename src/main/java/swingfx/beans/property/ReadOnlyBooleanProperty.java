...
import swingfx.beans.binding.BooleanExpression;
...
public abstract class ReadOnlyBooleanProperty extends BooleanExpression
        implements swingfx.beans.property.ReadOnlyProperty<Boolean> {
     ...
     * {@link swingfx.beans.property.ReadOnlyProperty}. If the
    ...
    /**
     * Creates a {@link swingfx.beans.property.ReadOnlyObjectProperty} that holds the value
