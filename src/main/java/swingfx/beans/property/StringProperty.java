...
import swingfx.beans.value.WritableStringValue;
...
public abstract class StringProperty extends ReadOnlyStringProperty implements
        swingfx.beans.property.Property<String>, WritableStringValue {
     ...
     */
    @Override
    public void bindBidirectional(swingfx.beans.property.Property<String> other) {
     ...
     * @since JavaFX 2.1
     */
    public void bindBidirectional(swingfx.beans.property.Property<?> other, Format format) {
     ...
     * @since JavaFX 2.1
     */
    public <T> void bindBidirectional(swingfx.beans.property.Property<T> other, StringConverter<T> converter) {
