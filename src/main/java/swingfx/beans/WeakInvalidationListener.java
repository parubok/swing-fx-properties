...
/**
 * A {@code WeakInvalidationListener} can be used, if an {@link swingfx.beans.Observable}
 ...
 * {@link swingfx.beans.InvalidationListener}. The {@code WeakInvalidationListener} should
 ...
 * to soon.
 *
 * @see swingfx.beans.InvalidationListener
 * @see swingfx.beans.Observable
 *
 *
 * @since JavaFX 2.0
 */
public final class WeakInvalidationListener implements swingfx.beans.InvalidationListener, WeakListener {

    private final WeakReference<swingfx.beans.InvalidationListener> ref;
     ...
     */
    public WeakInvalidationListener(@NamedArg("listener") swingfx.beans.InvalidationListener listener) {
        if (listener == null) {
            throw new NullPointerException("Listener must be specified.");
        }
        this.ref = new WeakReference<swingfx.beans.InvalidationListener>(listener);
    }
