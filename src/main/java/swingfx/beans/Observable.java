...
public interface Observable {
    ...
    /**
     * Adds an {@link swingfx.beans.InvalidationListener} which will be notified whenever the
     ...
     * listener by calling {@link #removeListener(swingfx.beans.InvalidationListener)
     * removeListener} after use or to use an instance of
     * {@link WeakInvalidationListener} avoid this situation.
     *
     * @see #removeListener(swingfx.beans.InvalidationListener)
     *
     * @param listener
     ...
     */
    void addListener(swingfx.beans.InvalidationListener listener);
     ...
     *
     * @see #addListener(swingfx.beans.InvalidationListener)
     *
     * @param listener
