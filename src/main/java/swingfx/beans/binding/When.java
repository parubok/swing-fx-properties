...
public class When {
    ...
    private static class WhenListener implements InvalidationListener {
        ...
        private final WeakReference<swingfx.beans.binding.Binding<?>> ref;

        private WhenListener(swingfx.beans.binding.Binding<?> binding, ObservableBooleanValue condition, ObservableValue<?> thenValue, ObservableValue<?> otherwiseValue) {
            this.ref = new WeakReference<swingfx.beans.binding.Binding<?>>(binding);
            this.condition = condition;
    ...
    private static swingfx.beans.binding.NumberBinding createNumberCondition(
    ...
    public class NumberConditionBuilder {
         ...
         *            the value
         * @return the complete {@link swingfx.beans.binding.DoubleBinding}
         */
        public swingfx.beans.binding.NumberBinding otherwise(ObservableNumberValue otherwiseValue) {
            if (otherwiseValue == null) {
         ...
         * @return the complete {@link swingfx.beans.binding.DoubleBinding}
         */
        public swingfx.beans.binding.DoubleBinding otherwise(double otherwiseValue) {
         ...
         * @param otherwiseValue
         *            the value
         * @return the complete {@link swingfx.beans.binding.NumberBinding}
         */
        public swingfx.beans.binding.NumberBinding otherwise(float otherwiseValue) {
         ...
         * @return the complete {@link swingfx.beans.binding.NumberBinding}
         */
        public swingfx.beans.binding.NumberBinding otherwise(long otherwiseValue) {
     ...
     */
    private class BooleanCondition extends swingfx.beans.binding.BooleanBinding {
    ...
    public class BooleanConditionBuilder {
         ...
         * @param otherwiseValue
         *            the value
         * @return the complete {@link swingfx.beans.binding.BooleanBinding}
         */
        public swingfx.beans.binding.BooleanBinding otherwise(final ObservableBooleanValue otherwiseValue) {
            if (otherwiseValue == null) {
                throw new NullPointerException("Value needs to be specified");
            }
            if (trueResult != null)
     ...
     */
    private class StringCondition extends swingfx.beans.binding.StringBinding {
    ...
    public class StringConditionBuilder {
         ...
         * @param otherwiseValue
         *            the value
         * @return the complete {@link swingfx.beans.binding.StringBinding}
         */
        public swingfx.beans.binding.StringBinding otherwise(final ObservableStringValue otherwiseValue) {
            if (trueResult != null)
     ...
     */
    private class ObjectCondition<T> extends swingfx.beans.binding.ObjectBinding<T> {
    ...
    public class ObjectConditionBuilder<T> {
         ...
         * @param otherwiseValue
         *            the value
         * @return the complete {@link swingfx.beans.binding.ObjectBinding}
         */
        public swingfx.beans.binding.ObjectBinding<T> otherwise(final ObservableObjectValue<T> otherwiseValue) {
            if (otherwiseValue == null) {
                throw new NullPointerException("Value needs to be specified");
            }
            if (trueResult != null)
