...
import io.github.parubok.com.sun.swingfx.binding.BidirectionalContentBinding;
import io.github.parubok.com.sun.swingfx.binding.ContentBinding;
import io.github.parubok.com.sun.swingfx.binding.DoubleConstant;
import io.github.parubok.com.sun.swingfx.binding.FloatConstant;
import io.github.parubok.com.sun.swingfx.binding.IntegerConstant;
import io.github.parubok.com.sun.swingfx.binding.LongConstant;
import io.github.parubok.com.sun.swingfx.binding.ObjectConstant;
import io.github.parubok.com.sun.swingfx.binding.SelectBinding;
import io.github.parubok.com.sun.swingfx.binding.StringConstant;
import io.github.parubok.com.sun.swingfx.binding.StringFormatter;
import io.github.parubok.com.sun.swingfx.collections.ImmutableObservableList;
import io.github.parubok.com.sun.swingfx.collections.annotations.ReturnsUnmodifiableCollection;
import io.github.parubok.swingfx.beans.property.Property;
import io.github.parubok.swingfx.beans.value.ObservableBooleanValue;
...
import io.github.parubok.swingfx.collections.ObservableArray;
import io.github.parubok.swingfx.collections.ObservableFloatArray;
import io.github.parubok.swingfx.collections.ObservableIntegerArray;
...
import io.github.parubok.swingfx.util.StringConverter;
import io.github.parubok.swingfx.util.TriFunction;
...
public final class Bindings {
    ...
    /**
     * Creates a new {@link DoubleBinding} that calculates
    ...
    /**
     * Creates a new {@link IntegerBinding} that holds the length of a
     * {@link ObservableStringValue}.
     * <p>
     * Note: In this comparison a {@code String} that is {@code null} is
     ...
     * @since swing-fx-properties 1.11
     */
    public static <E> ObjectBinding<E> valueAt(final ObservableList<E> op, final int index, E defaultValue) {
        if (op == null) {
            throw new NullPointerException("List cannot be null.");
        }
        if (index < 0) {
    ...
    /**
     * Creates a new {@link BooleanBinding} that contains the element
    ...
    /**
     * Creates a new {@link DoubleBinding} that contains the element
    ...
    /**
     * Creates a new {@link FloatBinding} that contains the element
    ...
    /**
     * Creates a new {@link IntegerBinding} that contains the element
    ...
    /**
     * Creates a new {@link LongBinding} that contains the element
    ...
    /**
     * Creates a new {@link ObjectBinding} that contains the mapping of a specific key
    ...
    /**
     * Creates a new {@link BooleanBinding} that contains the mapping of a specific key
    ...
    /**
     * Creates a new {@link DoubleBinding} that contains the mapping of a specific key
    ...
    /**
     * Creates a new {@link FloatBinding} that contains the mapping of a specific key
    ...
    /**
     * Creates a new {@link IntegerBinding} that contains the mapping of a specific key
    ...
    /**
     * Creates a new {@link LongBinding} that contains the mapping of a specific key
     ...
     * in an {@link ObservableMap}. The {@code StringBinding} will hold {@code null}, if the {@code key} cannot be
     * found in the {@code ObservableMap}.
     *
     * @param op the {@code ObservableMap}
     * @param key the key in the {@code Map}
     * @param <K> type of the key elements of the {@code Map}
