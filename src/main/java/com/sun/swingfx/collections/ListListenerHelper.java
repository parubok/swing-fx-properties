...
public abstract class ListListenerHelper<E> extends ExpressionHelperBase {
    ...
    private static class SingleInvalidation<E> extends ListListenerHelper<E> {
        ...
        protected ListListenerHelper<E> addListener(InvalidationListener listener) {
            return new com.sun.swingfx.collections.ListListenerHelper.Generic<E>(this.listener, listener);
        }
    ...
    private static class SingleChange<E> extends ListListenerHelper<E> {
        ...
        @Override
        protected ListListenerHelper<E> addListener(InvalidationListener listener) {
            return new com.sun.swingfx.collections.ListListenerHelper.Generic<E>(listener, this.listener);
        }
    ...
    private static class Generic<E> extends ListListenerHelper<E> {
        ...
        @Override
        protected com.sun.swingfx.collections.ListListenerHelper.Generic<E> addListener(InvalidationListener listener) {
                ...
                for (int index = 0; index < invalidationSize; index++) {
                    if (listener.equals(invalidationListeners[index])) {
                        if (invalidationSize == 1) {
                            if (changeSize == 1) {
                                return new com.sun.swingfx.collections.ListListenerHelper.SingleChange<E>(changeListeners[0]);
                            }
                            invalidationListeners = null;
                            invalidationSize = 0;
                        } else if ((invalidationSize == 2) && (changeSize == 0)) {
                            return new com.sun.swingfx.collections.ListListenerHelper.SingleInvalidation<E>(invalidationListeners[1-index]);
                        } else {
            ...
            if (changeListeners != null) {
                for (int index = 0; index < changeSize; index++) {
                    if (listener.equals(changeListeners[index])) {
                        if (changeSize == 1) {
                            if (invalidationSize == 1) {
                                return new com.sun.swingfx.collections.ListListenerHelper.SingleInvalidation<E>(invalidationListeners[0]);
                            }
                            changeListeners = null;
                            changeSize = 0;
                        } else if ((changeSize == 2) && (invalidationSize == 0)) {
                            return new com.sun.swingfx.collections.ListListenerHelper.SingleChange<E>(changeListeners[1-index]);
                        } else {
