...
public class ObservableSetWrapper<E> implements ObservableSet<E> {
    ...
    private com.sun.swingfx.collections.SetListenerHelper<E> listenerHelper;
    ...
    private void callObservers(SetChangeListener.Change<E> change) {
        com.sun.swingfx.collections.SetListenerHelper.fireValueChangedEvent(listenerHelper, change);
    }
    ...
    public void addListener(InvalidationListener listener) {
        listenerHelper = com.sun.swingfx.collections.SetListenerHelper.addListener(listenerHelper, listener);
    }
    ...
    public void removeListener(InvalidationListener listener) {
        listenerHelper = com.sun.swingfx.collections.SetListenerHelper.removeListener(listenerHelper, listener);
    }
    ...
    public void addListener(SetChangeListener<?super E> observer) {
        listenerHelper = com.sun.swingfx.collections.SetListenerHelper.addListener(listenerHelper, observer);
    }
