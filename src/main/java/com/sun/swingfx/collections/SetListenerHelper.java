...
public abstract class SetListenerHelper<E> extends ExpressionHelperBase {
    ...
    private static class SingleInvalidation<E> extends SetListenerHelper<E> {
        ...
        protected SetListenerHelper<E> addListener(InvalidationListener listener) {
            return new com.sun.swingfx.collections.SetListenerHelper.Generic<E>(this.listener, listener);
        }
    ...
    private static class SingleChange<E> extends SetListenerHelper<E> {
        ...
        @Override
        protected SetListenerHelper<E> addListener(InvalidationListener listener) {
            return new com.sun.swingfx.collections.SetListenerHelper.Generic<E>(listener, this.listener);
        }
    ...
    private static class Generic<E> extends SetListenerHelper<E> {
        ...
        @Override
        protected com.sun.swingfx.collections.SetListenerHelper.Generic<E> addListener(InvalidationListener listener) {
                ...
                for (int index = 0; index < invalidationSize; index++) {
                    if (listener.equals(invalidationListeners[index])) {
                        if (invalidationSize == 1) {
                            if (changeSize == 1) {
                                return new com.sun.swingfx.collections.SetListenerHelper.SingleChange<E>(changeListeners[0]);
                            }
                            invalidationListeners = null;
                            invalidationSize = 0;
                        } else if ((invalidationSize == 2) && (changeSize == 0)) {
                            return new com.sun.swingfx.collections.SetListenerHelper.SingleInvalidation<E>(invalidationListeners[1-index]);
                        } else {
            ...
            if (changeListeners != null) {
                for (int index = 0; index < changeSize; index++) {
                    if (listener.equals(changeListeners[index])) {
                        if (changeSize == 1) {
                            if (invalidationSize == 1) {
                                return new com.sun.swingfx.collections.SetListenerHelper.SingleInvalidation<E>(invalidationListeners[0]);
                            }
                            changeListeners = null;
                            changeSize = 0;
                        } else if ((changeSize == 2) && (invalidationSize == 0)) {
                            return new com.sun.swingfx.collections.SetListenerHelper.SingleChange<E>(changeListeners[1-index]);
                        } else {
