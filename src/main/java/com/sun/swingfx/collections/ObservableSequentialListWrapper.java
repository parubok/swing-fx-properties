...
import swingfx.collections.ModifiableObservableListBase;
...
public final class ObservableSequentialListWrapper<E> extends ModifiableObservableListBase<E> implements ObservableList<E>, SortableList<E> {
    ...
    private final com.sun.swingfx.collections.ElementObserver elementObserver;
    private com.sun.swingfx.collections.SortHelper helper;
    ...
    public ObservableSequentialListWrapper(List<E> list, Callback<E, Observable[]> extractor) {
        backingList = list;
        this.elementObserver = new com.sun.swingfx.collections.ElementObserver(extractor, new Callback<E, InvalidationListener>() {
    ...
    public void sort() {
        ...
        fireChange(new com.sun.swingfx.collections.NonIterableChange.SimplePermutationChange<E>(0, size(), perm, this));
    }
    ...
    private com.sun.swingfx.collections.SortHelper getSortHelper() {
        if (helper == null) {
