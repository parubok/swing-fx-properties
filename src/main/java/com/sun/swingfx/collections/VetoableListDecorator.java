...
public abstract class VetoableListDecorator<E> implements ObservableList<E> {
    ...
    private com.sun.swingfx.collections.ListListenerHelper<E> helper;
    ...
    public VetoableListDecorator(ObservableList<E> decorated) {
        ...
        this.list.addListener((ListChangeListener.Change<? extends E> c) -> {
            com.sun.swingfx.collections.ListListenerHelper.fireValueChangedEvent(helper,
    ...
    public void addListener(ListChangeListener<? super E> listener) {
        helper = com.sun.swingfx.collections.ListListenerHelper.addListener(helper, listener);
    }

    @Override
    public void removeListener(ListChangeListener<? super E> listener) {
        helper = com.sun.swingfx.collections.ListListenerHelper.removeListener(helper, listener);
    }
