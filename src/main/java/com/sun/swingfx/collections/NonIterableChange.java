...
public abstract class NonIterableChange<E> extends Change<E> {
    ...
    public String toString() {
        ...
        String ret;
        if (wasPermutated()) {
            ret = com.sun.swingfx.collections.ChangeHelper.permChangeToString(getPermutation());
        } else if (wasUpdated()) {
            ret = com.sun.swingfx.collections.ChangeHelper.updateChangeToString(from, to);
        } else {
