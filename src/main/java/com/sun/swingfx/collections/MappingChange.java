...
public final class MappingChange<E, F> extends Change<F>{
    ...
    public String toString() {
        ...
        while (next()) {
            if (wasPermutated()) {
                b.append(com.sun.swingfx.collections.ChangeHelper.permChangeToString(getPermutation()));
            } else if (wasUpdated()) {
                b.append(com.sun.swingfx.collections.ChangeHelper.updateChangeToString(getFrom(), getTo()));
            } else {
